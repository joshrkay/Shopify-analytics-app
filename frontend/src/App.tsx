...
function FeatureGateRoute({ feature, entitlements, loading, error, onRetry, children }: FeatureGateRouteProps) {
  ...
  if (error) {
    return (
      <Banner
        ...
        action={{ content: 'Retry', onAction: () => { void onRetry(); } }}
      >
        {error}
      </Banner>
    );
