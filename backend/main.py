...
from src.api.routes import shopify_entry
...
# Include Shopify embedded app entry point (bypasses authentication)
# Handles GET / when Shopify Admin navigates iframe with hmac/shop/host query params
app.include_router(shopify_entry.router)
